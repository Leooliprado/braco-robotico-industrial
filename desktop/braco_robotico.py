...
def rum_braco():
    ...
    def enviar_comando():
        nonlocal ultimo_envio, estado_anterior
        agora = time.time()
    ...
    while running:
        ...
        screen.blit(font.render(f"Passo base: {passo_base}", True, (0, 0, 0)), (20, 10))
        screen.blit(font.render(f"Passo atual: {passo_atual}", True, (0, 0, 0)), (20, 35))
        screen.blit(font.render(f"Modo rápido: {'Sim' if modo_rapido else 'Não'}", True, (0, 0, 0)), (20, 60))
        screen.blit(font.render(f"X: {eixos['X']['sentido']}", True, (0, 0, 0)), (20, 90))
        screen.blit(font.render(f"Y: {eixos['Y']['sentido']}", True, (0, 0, 0)), (20, 115))
